...
<h1 class="has-text-centered is-size-3">商品更新</h1><br>
<form action="M2-3-2.php"method="post">
...
<p class="has-text-centered">販売価格<input type="number" name="s_price" required></p><br>
<p class="has-text-centered">商品説明<input type="text" name="s_detail" required></p><br>
<nac class="level">
<b class="level-item">
<a href="M2-2.php" class="button is-medium">戻る</a>
